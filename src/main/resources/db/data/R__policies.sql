...
VALUES ('AGE_14_OR_OLDER', '만 14세 이상 동의', '본인은 만 14세 이상임을 확인합니다.', TRUE, 1.0),
       ...
       ('MARKETING_COMMUNICATION_CONSENT', '마케팅 정보 수신 동의', '서비스 소식과 혜택 정보를 수신하며, 동의는 언제든지 철회할 수 있습니다.', FALSE, 1.0)
