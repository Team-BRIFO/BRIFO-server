package com.brifo.server.external

import com.brifo.server.external.log.entity.ExternalApiCallLog
import com.brifo.server.external.log.entity.ExternalApiCallStatus
import com.brifo.server.external.log.service.ExternalApiCallLogService
import com.brifo.server.external.log.service.ExternalApiCallLogWriter
...
class ExternalApiCallServiceUnitTest {
    ...
    fun `API별 timeout과 retry 초기값이 정확하다`() {
        val expectedTimeouts =
            mapOf(
                ExternalApiCallPolicy.KIS_CURRENT_PRICE to 3L,
                ExternalApiCallPolicy.KIS_CLOSING_PRICE to 5L,
                ExternalApiCallPolicy.NEWS_DISCLOSURE to 5L,
                ExternalApiCallPolicy.FAST_API to 15L,
            )
